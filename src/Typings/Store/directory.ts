...
export interface IDirectory {
    files: string[]; // References file within file reducer
    numFiles: number;
    skippedFiles: string[];
    dirName: string;
    size: number;
...
export type ListenDirectoryRequest = AppActionBase<typeof LISTEN_DIRECTORY, "REQUEST"> & { callback: (dirPath: string) => void };
export type ListenDirectorySuccess = AppActionBase<typeof LISTEN_DIRECTORY, "SUCCESS"> & { callback: () => void };
...
export type InitDirectorySearchRequest = AppActionBase<typeof INIT_DIRECTORY_SEARCH, "REQUEST"> & {
    dirName: string;
    pattern: string;
...
export type DirectoryActionTypes =
    | typeof FETCH_FILES
    | typeof FETCH_IS_DIR
    | typeof FETCH_FILE_EXISTS
    | typeof MAKE_DIRECTORY
    | typeof LISTEN_DIRECTORY
    | typeof UNLISTEN_DIRECTORY
    | typeof FETCH_DIRECTORY_SIZE
    | typeof INIT_DIRECTORY_SEARCH
    | typeof DIRECTORY_SEARCH_PARTIAL_RESULT
    | typeof CANCEL_DIRECTORY_SEARCH
    | typeof PUSH_HISTORY
    | typeof POP_HISTORY
    | typeof UPDATE_HISTORY_IDX;
