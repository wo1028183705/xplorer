...
export const FILE_OPERATION = "FILE_OPERATION"; // * Internal
...
export type FileOperationSuccess = AppActionBase<typeof FILE_OPERATION, "SUCCESS"> & { operation: IOperation };
export type FileOperationFailure = AppActionBase<typeof FILE_OPERATION, "FAILURE"> & { message: string };
...
export type FileActions =
    ...
    | PurgeFilesSuccess
    | PurgeFilesFailure
    | OpenFilePreviewSuccess
    | CloseFilePreviewSuccess
...
export type FileActionTypes =
    ...
    | typeof OPEN_FILE
    | typeof READ_ASSET
    | typeof READ_JSON_FILE
    | typeof CREATE_FILE
    | typeof FETCH_FILE_PROPERTIES
    | typeof IS_DIRECTORY
    | typeof EXTRACT_ICON
    | typeof CALCULATE_FILE_SIZE
    | typeof RENAME_FILE
    | typeof COPY_FILE
    | typeof CUT_FILE
    | typeof REMOVE_FILE
    | typeof REVEAL_FILE
    | typeof GET_TRASHED_FILES
    | typeof DELETE_FILES
    | typeof RESTORE_FILE
    | typeof RESTORE_FILES
    | typeof PURGE_FILES
    | typeof OPEN_FILE_PREVIEW
    | typeof CLOSE_FILE_PREVIEW
    | typeof FILE_OPERATION;
